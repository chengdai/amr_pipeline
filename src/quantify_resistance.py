...
def quantify_resistomes(f):
    ...
    fastq_read_1 = f + '_1_sequence_kneaddata_paired_1.fastq'
    fastq_read_2 = f + '_1_sequence_kneaddata_paired_2.fastq'
    fastq_unpaired_1 = f + '_1_sequence_kneaddata_unmatched_1.fastq'
    fastq_unpaired_2 = f + '_1_sequence_kneaddata_unmatched_2.fastq'
...
def main():
    ...
    files = set([f.split('_1_')[0] for f in glob.glob(fastq_folder + '*.fastq*')])
    out_path = args.out
